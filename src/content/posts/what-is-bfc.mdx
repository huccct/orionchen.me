...
seoTitle: 什么是 BFC？一篇讲清 Block Formatting Context 和常见应用
seoDescription: 从概念、触发条件到清除浮动和防止外边距重叠，系统理解 BFC（块级格式化上下文）在前端开发中的实际作用。
seoKeywords:
  - 什么是 BFC
  - BFC
...
![BFC 包含浮动元素的效果](https://cdn.jsdelivr.net/gh/huccct/picx-images-hosting@master/image.8hgr4djgpf.webp)
...
![BFC 防止外边距重叠](https://cdn.jsdelivr.net/gh/huccct/picx-images-hosting@master/image.1zijb2arbv.webp)
...
```
![BFC 自适应两栏布局](https://cdn.jsdelivr.net/gh/huccct/picx-images-hosting@master/image.sz82hp8bl.webp)
