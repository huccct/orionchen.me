...
## Mindset: you're not making a PPT, you're writing a design brief
...
## Tool ranking: which LLMs actually output something good
...
## Design tokens: the "swatch" you give to the AI
...
## Anti-AI-Slop checklist: lock in "what not to do"
...
## Per-page "intent": the layout rhythm a deck should have
...
## A long prompt you can copy verbatim
...
## Single-case iteration: how to make it better, not worse
